...
export function CommentOverlay({
  ...
  /** Mode to enter on mount. The lazy wrapper only mounts this overlay once
   *  the user has invoked comment mode, so it defaults to "on". */
  startMode?: "off" | "on";
}) {
  ...
  const [mode, setMode] = useState<"off" | "on">(startMode);
